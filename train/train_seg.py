...
class Solver():
    def __init__(self):
        ...
        self.model_name = str(datetime.date.today()) + \
            '_seg_net_'+self.args.gar_type
        self.get_gpus()
        ...
        self.network = network.UnetGenerator(
        ...
        self.optim = opt.Adam(params=self.network.parameters(),
    ...
    def get_args(self):
        ...
        ap.add_argument("-g", "--gpu_ids", type=str,
                        default="0", help="gpu ids, -1 for cpu")
        ap.add_argument("-dr", "--dataroot", type=str,
                        default="./data/shirts", help="location of training datset")
        ap.add_argument("-w", "--num_workers", type=int,
                        default=1, help="number of workers")
        ap.add_argument("-lr", "--lr", type=float,
                        default=0.0001, help="Learning rate")
        ap.add_argument("-c", "--check_print", type=int,
                        default=100, help="check point after these iterations")
        ap.add_argument("-s", "--save_point", type=int,
                        default=10, help="Save models after this epoch")
        ap.add_argument("--side", type=str2bool, default=True,
                        help="Whether to use the fron or the back")
            ...
            for step, sample in enumerate(self.train_dataloader):
                ...
                if (step + 1) % self.args.check_print == 0:
                    ...
                    log = "Elapsed [{}], Epoch [{}] Iteration [{}/{}]".format(
                        et, epoch + 1, step + 1, self.iter_p_batch)
